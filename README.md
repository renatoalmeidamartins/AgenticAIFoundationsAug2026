...
- [CrewAI multi-agent sample](https://docs.crewai.com/v1.15.17/en/guides/crews/first-crew)
- [LangGraph sample](https://docs.langchain.com/oss/python/langgraph/quickstart#full-code-example)
- [LangChain agents](https://docs.langchain.com/oss/javascript/langchain/agents)
- [Microsoft Semantic Kernel, now called Microsoft Agent Framework](https://devblogs.microsoft.com/agent-framework/semantic-kernel-and-microsoft-agent-framework/)
...
- [List of Strands tools](https://github.com/strands-agents/tools)
- [All features available in agentcore](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/what-is-bedrock-agentcore.html)
